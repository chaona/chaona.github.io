...
function ttkefu_WindowOpen(url,paras){
	...
	window.open(url,"54982","top=0,left="+vleft+",width="+vwidth+",height="+vheight+",scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes");
...
function ttkefu_Com_TalkLinkParas(MsgData){
	/*url参数整理*/
            var GoUrl="https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?fgid=7158&t5Ys2R=54982&lang=0";
...
var ttkefu_city="";
if (getCookie("mmaain")==document.domain&&getCookie("kuse")=="54982"){
	mmaain=document.domain;
	setCookie("mmaain",mmaain,"s20");
    setCookie("kuse","54982","d1");
	src1="";
}else{
	mmaain=document.domain;
    setCookie("mmaain",mmaain,"s20");
    ...
    src1="https://w1011.ttkefu.com/online.jsp?k=7591&lailu="+Mreferrer+"&urll="+encodeURIComponent(document.location.href)+"&tS4wJ7="+sjs+"&t5Ys2R=54982&fid=7158&guanjianzi="+guanjianzi+"&zxrs=0";
...
function tana(dkfs){
    ...
    /**/
	window.open("https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?u=7158&t5Ys2R=54982&tS4wJ7="+sjs+"&fgid=7158&s2N6eL=54982&isshowstyle=1&dkfs="+dkfs+"&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle)+"&xx="+Math.random(),"54982","top=0,left=100,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes")
...
function randtantel(){
    ...
    window.open("https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/randtel.jsp?u=7158&tS4wJ7="+sjs+"&kfid=7591&fgid=7158&s2N6eL=54982&isshowstyle=1&dkfs=tel","54982","top=200,left="+iLeft+",width=320,height=450,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes")
}
...
function listtana(weburl,nicheng){
    var str=weburl;
		...
		window.open(weburl,"54982","top=0,left=100,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes")
...
function tanac(str,dkfs){
	...
	window.open("https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?u=7158&t5Ys2R=54982&tS4wJ7="+sjs+"&zixun="+encodeURIComponent(str)+"&fgid=7158&s2N6eL=54982&dkfs="+dkfs+"&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle)+"","54982","top=0,left=100,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes")
...
function tanbc(kuid,use,str,dkfs){
	...
	try{
		var win=window.open('https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?R5s6eT='+kuid+'&t5Ys2R=54982&zixun='+encodeURIComponent(str)+'&fgid=7158&s2N6eL='+use+'&tS4wJ7='+sjs+'&dkfs='+dkfs+"&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle)+"",'54982','top=120,left=200,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes');
		if(win==null){
			window.location.href='https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?R5s6eT='+kuid+'&t5Ys2R=54982&zixun='+encodeURIComponent(str)+'&fgid=7158&s2N6eL='+use+'&tS4wJ7='+sjs+'&dkfs='+dkfs+"&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle);
		}
	}catch(e){
		window.location.href='https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?R5s6eT='+kuid+'&t5Ys2R=54982&zixun='+encodeURIComponent(str)+'&fgid=7158&s2N6eL='+use+'&tS4wJ7='+sjs+'&dkfs='+dkfs+"&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle);
	}
...
function tantel(s,dkfs){
    var iLeft = (window.screen.availWidth-330)/2;   
    window.open(s+"&fgid=7158&dkfs="+dkfs,"_blank","top=200,left="+iLeft+",width=320,height=450,align=center,crollbars=no,resizable=yes,status=yes,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes");
}

function tanteluid(telu_id,sjs){
    var iLeft = (window.screen.availWidth-330)/2;   
    window.open("https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/tel.jsp?userid=54982&useid="+telu_id+"&khbh="+sjs+"&fgid=7158&dkfs=1","_blank","top=200,left="+iLeft+",width=320,height=450,align=center,crollbars=no,resizable=yes,status=yes,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes");
}
...
function onner(){
    var ycurl="https://w1011.ttkefu.com/yc.jsp?k=54982&j="+sjs+"&f=7158&r="+encodeURIComponent(document.location.href)+"&s="+Math.random();
    if(isfrist==""){
        ...
        ycurl="https://w1011.ttkefu.com/yc.jsp?k=54982&t="+encodeURIComponent(document.title)+"&j="+sjs+"&style_lang=0&f=7158&r="+encodeURIComponent(document.location.href)+"&g="+guanjianzi+"&s="+Math.random()+"&l="+Onner_Referrer;
        isfrist="1";
    }
    mmaain=document.domain;
	setCookie("mmaain",mmaain,"s20");
...
function ttkefuGetWzLgInfo(MsgData){
    ...
    DBdWzHy_Url=DBdWzHy_Url+"&kuse="+"54982";
    DBdWzHy_Url=DBdWzHy_Url+"&uid="+mini_dialog.khid;
    DBdWzHy_Url=DBdWzHy_Url+"&fgid="+"7158";
...
var mini_dialog={
    ...
    sendmsg:function(){
    	...
    	if(this.duihuaxuanze==0 && this.zhidingkefu==0){
            ...
            if(document.getElementById("ttkefu_KfList_div")){
                ...
                var new_script = document.createElement("script");
                //act:err:82
                new_script.src = "https://w1011.ttkefu.com/minimsg.jsp?f=0&zhidingkefu=0&fgid=7158&act="+mini_dialog.act+"&tS4wJ7="+sjs;
    ...
    GTrebotanswer:function(vid){
        var url="https://w1011.ttkefu.com/DTTSer.jsp?act=GTrebot_answer&kuse=54982&fgid=7158&id="+vid+"&jsoncallback=mini_dialog.Getrebot_answer";  
        var new_script = document.createElement("script"); 
        new_script.src =url;
        document.getElementsByTagName("HEAD")[0].appendChild(new_script);
    ...
    //var url="https://w1011.ttkefu.com/DTTSer.jsp";      
    var url="https://w1011.ttkefu.com/DTTSer.jsp?act=GTHotLst&kuse=54982&fgid=7158&jsoncallback=mini_dialog.GetRecomand";  
    var new_script = document.createElement("script"); 
    new_script.src =url;
    document.getElementsByTagName("HEAD")[0].appendChild(new_script);
    document.getElementsByTagName("HEAD")[0].removeChild(new_script);
      //  mini_dialog.conn(url,{act:"GTHotLst",kuse:"54982",fgid:"7158",jsoncallback:"mini_dialog.GetRecomand"},mini_dialog.GetRecomand);        
    },
    ...
    saveFile:function(vid){
      ...
      document.getElementById('info').src="https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/ttsave.jsp?kid="+mini_dialog.chatid;
                ...
                if(MsgData.a>0){
                        ...
                        ttkefu_font.onclick=function(){
                                if(this.getAttribute("zt")=="离线"){
                                        listtana('https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?R5s6eT="+this.getAttribute("kf")+"&t5Ys2R=54982&s2N6eL=this.getAttribute("gh")&fgid=7158&tS4wJ7='+sjs,this.getAttribute("nc"));
    ...
    maxwindow:function(){
        ...
        else
        {
                ...
                {
                    /*tana('2');*/
                    window.open("https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?u=7158&t5Ys2R=54982&tS4wJ7="+sjs+"&fgid=7158&s2N6eL=54982&isshowstyle=1&dkfs=2&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle)+"","54982","top=0,left=100,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes")
                }
                else
                {
                   var weburl="https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/chat_boxs.jsp?R5s6eT="+mini_dialog.zhidingkefu+"&t5Ys2R=54982&s2N6eL="+mini_dialog.use+"&fgid=7158&tS4wJ7="+sjs+"&dkfs=2&lang=0&Purl="+ttkefu_pageurl+"&Pt="+ttkefu_pagetitleLimtit(ttkefu_pagetitle);
                   window.open(weburl,"54982","top=0,left=100,width=849,height=619,scrollbars=no,resizable=yes,status=no,z-look=yes,alwaysRaised=yes,location=no,depended=no,center:yes");
                }
...
document.getElementById("ttkefuminitishi").style.height="151px";
    ...
    pingfen:function(IsExit){
      ...
      //  document.getElementById('ttkefuminitxtlimit').style.display='';
        ...
        document.getElementById('ttkefuminitishi_txt').innerHTML='<span id="wen" style="display:block;margin-bottom:15px;font-size: 16px;font-family: 微软雅黑;">您对本次服务满意吗？</span><div class="kschatwindowstandard_popup_evaluate_starshow"><p class="kschatwindowstandard_star_evaluation" id="ksdefault_selected" style="margin-bottom:15px" onMouseOver="rate(this,event)"><img class="ttkefuminirad" src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="5"><img class="ttkefuminirad" src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="4"><img class="ttkefuminirad" src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="3"><img class="ttkefuminirad" src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="2"><img class="ttkefuminirad" src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="1"></p><div id="aaa" style="display: flex;color:#ff9a55;margin-bottom:15px;justify-content: center;align-items: center;padding: 0 10px;"><img src="https://w1011.ttkefu.com/img/icon_satisfied_very.png" style="margin-right:10px" alt="">非常满意 </div></div><textarea name="ttkefuminitxt" id="ttkefuminitxt" style="height:56px;outline:none;resize:none;padding:5px;border:1px solid #dbdbdb" placeholder="还有哪些地方需要改进？" cols="20"></textarea>';
    ...
    tijiaopingfen:function(chatid,IsExit){
      ...
      if(mini_dialog.isfirst>0)
       ...
       for(i=0;i<5;i++)
       {
       		...
       		if(item.getAttribute("src")=="https://w1011.ttkefu.com/img/icon_starmini_on.png")
            {
       ...
       /*评分数据*/       
        var new_script = document.createElement("script");
        if(IsExit==0){
        	new_script.src ="https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/pingfenyemian.jsp?act=minipingfen&pf="+mypingfen+"&jy="+encodeURIComponent(ttkefuminipftxt)+"&id="+chatid;
         }
        else{
        	new_script.src ="https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/pingfenyemian.jsp?act=minipingfen&pf="+mypingfen+"&jy="+encodeURIComponent(ttkefuminipftxt)+"&id="+chatid;
        }
...
/*		if(document.all)
    ...
    closewindow:function(){
          if(mini_dialog.isfirst>0)
          {
            mini_dialog.exiturl="https://w1011.ttkefu.com/minimsg.jsp?act=exit&ki="+mini_dialog.kfid+"&minikhid="+mini_dialog.khid+"&fgid=7158&dkfs=&c="+mini_dialog.chatid;
            var new_script = document.createElement("script");
          ...
          document.getElementById("ttkefucontainer").innerHTML='<div qzwz="0" style="padding:0px; margin:0px;font-size: 9pt;height: auto;line-height: 19px;margin:0px 0px 10px 0px;overflow: hidden;position: relative; "><div style="padding:12px 12px 12px 12px; border-radius:5px; font-size: 9pt; height: auto;line-height: 19px; margin: 0px 0px 10px 4px;overflow: hidden; border:1px solid #e4e4e4; color:#000000; ">ttkefu是一款免费的网页即时聊天、微信即时聊天的客服软件,免费申请网址:<a href="https://www.ttkefu.com"  style="text-decoration: none; color:#000;" target="_blank">https://www.ttkefu.com</a></div><div style="padding:0px; margin:0px;height:8px;left:0px;position: absolute; top: 11px; width: 11px;"></div></div>'+mini_dialog.kfhtmlheader+Jsinv_text+mini_dialog.kfhtmlfooter+"<div class='ttkefu_jg' style='height:10px;padding:0px; margin:0px;font-size: 9pt; margin: 0px 0px 0px 0px;overflow: hidden; clear:both; '></div>";
    ...
    stoploop:function(){
          ...
          document.getElementById("ttkefucontainer").innerHTML='<div qzwz="0" style="padding:0px; margin:0px;font-size: 9pt;height: auto;line-height: 19px;margin:0px 0px 10px 0px;overflow: hidden;position: relative; "><div style="padding:12px 12px 12px 12px; border-radius:5px; font-size: 9pt; height: auto;line-height: 19px; margin: 0px 0px 10px 4px;overflow: hidden; border:1px solid #e4e4e4; color:#000000; ">ttkefu是一款免费的网页即时聊天、微信即时聊天的客服软件,免费申请网址:<a href="https://www.ttkefu.com"  style="text-decoration: none; color:#000;" target="_blank">https://www.ttkefu.com</a></div><div style="padding:0px; margin:0px;height:8px;left:0px;position: absolute; top: 11px; width: 11px;"></div></div>'+mini_dialog.kfhtmlheader+Jsinv_text+mini_dialog.kfhtmlfooter+'<div style="height:10px;padding:0px; margin:0px;font-size: 9pt;line-height: 19px;margin: 0px 0px 0px 0px;overflow: hidden; clear:both; " class="ttkefu_jg"></div>';
    ...
    exit:function(){
          ...
          document.getElementById("ttkefucontainer").innerHTML='<div qzwz="0" style="padding:0px; margin:0px;font-size: 9pt;height: auto;line-height: 19px;margin:0px 0px 10px 0px;overflow: hidden;position: relative; "><div style="padding:12px 12px 12px 12px; border-radius:5px; font-size: 9pt; height: auto;line-height: 19px; margin: 0px 0px 10px 4px;overflow: hidden; border:1px solid #e4e4e4; color:#000000; ">ttkefu是一款免费的网页即时聊天、微信即时聊天的客服软件,免费申请网址:<a href="https://www.ttkefu.com"  style="text-decoration: none; color:#000;" target="_blank">https://www.ttkefu.com</a></div><div style="padding:0px; margin:0px;height:8px;left:0px;position: absolute; top: 11px; width: 11px;"></div></div>'+mini_dialog.kfhtmlheader+Jsinv_text+mini_dialog.kfhtmlfooter+'<div class="ttkefu_jg" style="height:10px;padding:0px; margin:0px;font-size: 9pt;line-height: 19px;margin: 0px 0px 0px 0px;overflow: hidden; clear:both; "></div>';
...
var str="<style type='text/css'>#minidialog div{font-size:9pt;font-family:微软雅黑}.lists li:hover{background:#eee}.laba{background-position: 0px -223px !important;}.lists li:nth-child(1){margin-left:0}.lists li{margin-left:10px;list-style: none;padding: 2px 8px;font-size: 12px;color: #515A71;background-color: #fff;border: 1px solid #E3E3E3;border-radius:10px;-webkit-border-radius:10px;-moz-border-radius: 3px;-ms-border-radius: 3px;-o-border-radius: 3px;cursor: pointer;float: left;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;white-space: pre;}.icon:hover{color:#dbd3d3 !important}#sendMsgTxt_chat::-webkit-input-placeholder{color:#9E9E9E;}.wt:hover{background-color:"+mini_dialog.titlebg+";border-radius: 20px;}.jianjiao:before{    content: '';width: 0;height: 0;border: 6px solid transparent;border-left-color: "+mini_dialog.titlebg+";position: absolute;left: 100%;top: 15px;margin-top: -3px;}.kfjaja:before{    content: '';width: 0;height: 0;border: 6px solid transparent;border-right-color:#ededed;position: absolute;right: 100%;top: 15px;margin-top: -3px;}#tt_fkdiv a{color:#fff;text-decoration: none;}</style>";
document.write(str);

str="<style type='text/css'>.dot {display: flex;flex-direction: row;align-items: center;justify-content: center;}  .dot1,.dot2,.dot3 {width: 7.5px;height: 7.5px;border-radius: 50%;margin: 5px;background: blue;}   .dot1 {animation: jump 1.6s -0.32s linear infinite;}.dot2 {animation: jump 1.6s -0.16s linear infinite;}.dot3 {animation: jump 1.6s linear infinite;} @keyframes jump {0%,80%,100% {-webkit-transform: scale(0);   transform: scale(0);}40% {-webkit-transform: scale(2.0);transform: scale(2.0);}}</style>";
document.write(str);

document.write('<div id="minidialog" onClick="mini_dialog.clear(timerkkff)" style="background-color: transparent;box-shadow: 0 0 20px 0 rgb(0 0 0 / 15%);display:none; width:300px; padding:0px; margin:0px; right:0px; bottom:0px; position:fixed;_position:absolute; overflow:hidden; z-index:2147483640;">');
document.write('<div id="ttkefuminidialogtitle" onClick="if(mini_dialog.windowstate==1){ mini_dialog.maxwindow()}" style="width:300px;padding:0px; margin:0px; height:44px; line-height:35px; cursor: pointer; margin: 0 auto; font-family:Microsoft YaHei; text-indent:5px;font-size:13px;background:#6BC1FA url(https://w1011.ttkefu.com/images/kf.png) no-repeat 10px center; overflow:hidden;border-top-left-radius:3px;border-top-right-radius:3px;">');

document.write('<div id="ttkefu_minit0" style="padding:0px; width:150px;overflow: hidden; float:left; text-align:left; margin:5px 0px 0px 0px; padding:0px;"><span id="ttkefutitle" style=" background:none; display:inline; width:auto; float:none;color:#FFFFFF; padding:0px 0px 0px 32px;   height:39px; line-height:34px; font-size:9pt; ">在线客服咨询</span><span id="ttkefuonlineKefuName" a="0" style="margin-left:1px; background:none;color:#FFFFFF;font-size:9pt; "></span><span style="color: rgb(0, 0, 0); margin-left: 0px; display: none;" id="kefuShow">正在输入中...</span></div><div id="ttkefu_minit1" style="padding:0px; display:none; width:190px;overflow: hidden; float:left; text-align:left; margin:5px 0px 0px 0px; padding:0px;"><span id="ttkefutitle" style="color:#FFFFFF; padding:0px 0px 0px 35px;  line-height:35px; font-size:13px; height:39px; line-height:35px;">对方正在输入中...</span></div><div id="ttkefu_minwindow_min" style="background:url(https://w1011.ttkefu.com/images/close_chat_ico.gif) no-repeat;cursor:pointer; width:27px; height:25px; float:right;margin:9px 0px 0px 0px;" onClick="mini_dialog.miniwindow()"  onMouseOver="ttkefu_minwindow_Over(this)" onMouseOut="ttkefu_minwindow_Out(this)">&nbsp;</div><div id="ttkefu_minwindow_max" onClick="mini_dialog.maxwindow()"  onMouseOver="ttkefu_minwindow_Over(this)" onMouseOut="ttkefu_minwindow_Out(this)" style=" background:url(https://w1011.ttkefu.com/images/yxjreply0.gif) no-repeat;margin-right:0px; margin-top:15px; cursor:pointer; width:14px; height:21px;  float:right;"></div><div id="ttkefu_minwindow_close" style="background:url(https://w1011.ttkefu.com/images/yxjminx0.gif) no-repeat;display:block; cursor:pointer; width:14px; height:21px; float:right; margin-right:10px; margin-top:15px;" onClick="mini_dialog.miniwindow()" onMouseOver="ttkefu_minwindow_Over(this)" onMouseOut="ttkefu_minwindow_Out(this)">&nbsp;</div><div id="laba" style="background-image:url(https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/images/tools.gif);background-position: 0px -45px;cursor:pointer; width:21px; height:21px; float:right; margin-right:10px; margin-top:12px;" >&nbsp;</div><!--<div id="laba" style="list-style: none;float: right;width: 15px;height: 21px;line-height: 25px;margin-right: 6px;margin-top:10px;background-image:url(https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/images/tools.gif);background-size: cover;background-repeat: no-repeat;background-attachment: initial;background-origin: initial;background-clip: initial;background-position: 0px -31px;">&nbsp;</div>-->');
document.write('</div>');
...
document.write('<div id="chat_div_main_wrapper"  style="padding:0px 1px 1px 1px; margin:0px; overflow:hidden;">');
/*关闭提醒-----*/
document.write('<div id="ttkefuminitishi" style="display:none; margin:0px; padding:0px; position:absolute; _position:absolute;z-index:2147483643;top:28%;;right:11%;; width:220px; height:128px;text-align:center;   border-radius: 12px;padding: 0px;background: rgb(255, 255, 255);border: 0px solid rgb(0, 0, 0);box-shadow: rgb(0 0 0 / 40%) 0px 3px 26px;">');
...
<!--document.write('<span id="wen" style="display:block;margin-bottom:15px">您对本次服务满意吗？</span>');-->
document.write('<div id="ttkefuminitishi_txt" style=" margin:0px;padding:0px 10px 10px 20px;color: #555; font-family:宋体;font-size: 12px;text-align:center; line-height:22px;">');
document.write('<div class="kschatwindowstandard_popup_evaluate_starshow">')
document.write('<p class="kschatwindowstandard_star_evaluation" id="ksdefault_selected" style="margin-bottom:15px" onMouseOver="rate(this,event)">')
document.write('<img src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="0"><img src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="1"><img src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="2"><img src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="3"><img src="https://w1011.ttkefu.com/img/icon_starmini_on.png" alt="" _num="4"></p>')
document.write('<div id="aaa" style="display: flex;color:#ff9a55;margin-bottom:15px;justify-content: center;align-items: center;padding: 0 10px;"><img src="https://w1011.ttkefu.com/img/icon_satisfied_very.png" style="margin-right:10px" alt="">非常满意 </div>')
document.write('</div>')
document.write('<textarea name="ttkefuminitxt" id="ttkefuminitxt" style="height:56px;outline:none;resize:none;padding:2px 10px" placeholder="您觉得我们还有哪些地方需要改进呢？" cols="20"></textarea>')
document.write('</div>')
...
document.write('<div id="ttkefuminitishiwrapper" style="display:none !important; margin:0px; padding:0px;position:absolute; _position:absolute;z-index:2147483642;top:28%;;right:7%; width:240px; height:250px;text-align:center;">');
document.write('<div id="ttkefuminitishiwrapperdiv" style=" margin:0px;border-radius: 12px; padding:0px;background:#fff; border:0px #000 solid; box-shadow: 0 3px 9px rgba(0, 0, 0, 0.4);  width:218px;height:151px; margin:auto;-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=50); filter:alpha(opacity=50); "></div>');
document.write('</div>');
/*End关闭提醒-----*/
...
document.write('</div>');
/*End自定义alert-----*/
document.write('<div id="chat_div_main" style="width:100%;padding:0px; margin:0px;height:201px; background:#fff;margin: 0 auto;overflow: hidden;font-size: 9pt;line-height: 19px;">');
...
document.write('<div id="cinv_dialogtool"  style="padding:0px; margin:0px;overflow: hidden; text-align: left;background:#fff; ">');
...
document.write('<div class="ShortcutOption" style="display: flex; height: 30px;width: 100%;display: flex;align-items: center;justify-content: space-between;background: white;">');
document.write(' <div class="movebtn" style=" width:15px;cursor: pointer;height: 25px;display: flex;align-items: center;justify-content: center;margin-left: 0px;">');
document.write('<span id="moveback" style="display: block;width: 0px;height: 0px;border: 3.5px solid #858585;border-top-color: transparent;border-bottom-color: transparent;border-left-color: transparent;border-right-color: #858585; margin-left: 3px;margin-right: 3px;"></span>');
document.write('</div>');
document.write('<div id="ShortcutOptions" style=" width: calc(100% - 30px);height: 30px;overflow-x: hidden;overflow-y: hidden;">');
document.write('<ul id="list" class="lists" style="margin:0;padding:0;height: 30px;display: flex;align-items: center;justify-content: flex-start;">');
	
		document.write('<li   rebot_answer="您好，咨询业务吗？" onClick="mini_dialog.getanswer(this)">您好</li>');
		document.write('<li   rebot_answer="请从对话框输入文字即可建立人工通道哦;营销语可从AI机器人中配置。" onClick="mini_dialog.getanswer(this)">联络我们</li>');
	
document.write('</ul></div>');
document.write('<div class="movebtn" style=" width:15px;cursor: pointer;height: 25px;display: flex;align-items: center;justify-content: center;margin-left: 0px;">');
document.write('<span id="movego" style="display: block;width: 0px;height: 0px;border: 3.5px solid #858585;border-top-color: transparent;border-bottom-color: transparent;border-left-color: #858585;border-right-color: transparent;"></span>');
document.write('</div>');
document.write(' </div>');

/*营销语结束*/

document.write('<div class="chat_tool_bar" style="width:100%;border-top: 1px solid #dce2e4;padding:0px; margin:0px; height:41px; margin:0 auto;">');
document.write('<ul style="margin:0px; padding:0px;width:100%;">');
document.write('<li style=" list-style:none; float:left; width:25px; height:25px; line-height:25px; margin:9px 0px 0px 4px;background: url(https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/images/tools.gif) no-repeat;background-position: 0px -20px;" onMouseOut="this.style.backgroundColor=\'\'" onMouseOver="this.style.backgroundColor=\'#C9C9C9\'" onClick="document.getElementById(\'uploadFileBox1\').style.display=\'block\';"  title="表情" id="ttkefu_biaoqing">&nbsp;</li>');
document.write('<li style=" list-style:none; float:left; width:25px; height:25px; line-height:25px; margin:10px 0px 0px 4px;background: url(https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/images/tools.gif) no-repeat;background-position: 0px -110px;" onMouseOut="this.style.backgroundColor=\'\'" onMouseOver="this.style.backgroundColor=\'#C9C9C9\'" onClick="mini_dialog.pingfen(0);"  title="评分" id="ttkefu_pingfen">&nbsp;</li>');
document.write(' <li style=" list-style:none; float:left; width:25px; height:25px; line-height:25px; margin:8px 0px 0px 4px;background: url(https://w1011.ttkefu.com/conversationormessage/ourcustomerservice/customerlist/images/tools.gif) no-repeat;background-position: 0px -132px;" onMouseOut="this.style.backgroundColor=\'\'" onMouseOver="this.style.backgroundColor=\'#C9C9C9\'" onClick="document.getElementById(\'ttkefuminitishi_txt_alert\').innerHTML=\'未开通\';document.getElementById(\'ttkefuminitishi_alert\').style.display=\'\';"  title="截图" id="ttkefu_biaoqing">&nbsp;</li>');
document.write('');

document.write('<li style=" list-style:none; float:right; width:25px; height:25px; line-height:25px; margin:3px 4px 0px 0px;margin:8px 4px 0px 0px;background: url(https://w1011.ttkefu.com/images/server/css/tool.gif) no-repeat;background-position: 0px -252px;" onMouseOut="c_tools_style(0,this)" onMouseOver="c_tools_style(1,this)" onClick="mini_dialog.saveFile(123)" title="导出聊天记录  " id="switch">&nbsp;</li>');
document.write('</ul></div>');
...
document.write('<textarea onKeyPress="return keypress(event);" onfocus="mini_dialog.sendtxtfoucs()" onblur="mini_dialog.sendtxtblur()"  id="sendMsgTxt_chat" name="sendMsgTxt_chat" placeholder="可输入文字或粘贴截图" style="resize:none;width:100%; height:63px;outline:none;padding:1px 0px 0px 2px;color:#333; float:left; font-size:12px; background:#fff; border:none; overflow-y:auto; line-height:19px;padding-left:6px; border-bottom:1px solid #e8e8e8;font-family:微软雅黑" class="chat_text" autocomplete="off" onfocus="document.getElementById(\'uploadFileBox1\').style.display=\'none\';" onKeyUp="mini_dialog.yuzhimsg()"></textarea>');
...
document.write('&nbsp;&nbsp;<input id="ttkefu_qzlm_phone" name="ttkefu_qzlm_phone" onFocus="mini_dialog.peyc()" onBlur="mini_dialog.pexs()" value="手机" style="magin:0px; padding:0px; width:86px; height:22px;color: #BEC2C3;border:1px solid #D4CCCC; font-size:12px" />');
...
/*  喇叭  */
			  ...
			  document.getElementById("laba").onclick=function(){
			  	if(!document.getElementById("laba").classList.contains("laba")){
			  		document.getElementById("laba").classList.add("laba");
                    mini_dialog.labaOpen=0;


			  	}else{
			  		document.getElementById("laba").classList.remove("laba");
                    mini_dialog.labaOpen=1;
...
/*评语*/
    ...
    function rate(obj, oEvent) {
        var imgSrc = 'https://w1011.ttkefu.com/img/icon_starmini_off.png';
        var imgSrc_2 = 'https://w1011.ttkefu.com/img/icon_starmini_on.png';
        var hitstxt = [];
        ...
        var hints = ['<img src="https://w1011.ttkefu.com/img/icon_poor_very.png" style="margin-right:10px" alt=""/>' + hitstxt[1],
        '<img src="https://w1011.ttkefu.com/img/icon_poor.png" style="margin-right:10px" alt=""/>' + hitstxt[2],
        '<img src="https://w1011.ttkefu.com/img/icon_generally.png" style="margin-right:10px" alt=""/>' + hitstxt[3],
        '<img src="https://w1011.ttkefu.com/img/icon_satisfied.png" style="margin-right:10px" alt=""/>' + hitstxt[4],
        '<img src="https://w1011.ttkefu.com/img/icon_satisfied_very.png" style="margin-right:10px" alt=""/>' + hitstxt[5]];
        var e = oEvent || window.event;
        var target = e.target || e.srcElement;
        var imgArray = obj.getElementsByTagName("img");
        var serviceEvaluate_num = document.getElementById('serviceEvaluate_num');
		 for (var i = 0; i < imgArray.length; i++) {
           
            imgArray[i].onmouseover = function () {
                var v = 6-parseInt(this.getAttribute('_num'));

                document.getElementById('serviceEvaluate_num').value = v;
                document.getElementById('serviceEvaluate').value = hitstxt[v];

            }
        }
        if (target.tagName == "IMG") {
            var _num = 5-target.getAttribute('_num');
            for (var j = 0; j < imgArray.length; j++) {
                ...
                var info = hitstxt[_num];
                document.getElementById("aaa").innerHTML = hints[_num]
            }
        } else {
            return false;
        }
...
/*	营销语js开始  20230724*/
  document.querySelector('#moveback').addEventListener('click',function () {
            console.log(123);
           var dom = document.querySelector('.ShortcutOption>div:nth-child(2)');
            dom.scrollLeft-=300
        })

        document.querySelector('#movego').addEventListener( 'click',function () {
            console.log(456);
            var dom = document.querySelector('.ShortcutOption>div:nth-child(2)');
            console.log(dom);
            dom.scrollLeft+=300
        })
       var ul = document.getElementById("list").children.length
   // console.log(ul);
        
        if(ul<3){
            document.querySelector('#moveback').style.display='none';
            document.querySelector('#movego').style.display='none'
        }
        /*营销语js结束*/
...
hotListBlockdata=window.localStorage.getItem("hotListBlockdata")
//console.log("localStorage数据"+hotListBlockdata);

if(hotListBlockdata!=null) mini_dialog.insertmsg(hotListBlockdata);


document.write("<div id='ttkefuico' style='position:fixed;_position:absolute;z-index:2147483639;left:1px;top:100px'>");
document.write("<img style='cursor:pointer;'  onClick=tana('2') src='https://w1011.ttkefu.com/images/kflogo/1/h2.gif' border='0' id='icoimg' usemap='#ttkefuMap' onload='setarea()' />");
document.write("<map name='ttkefuMap' id='ttkefuMap'  >");
document.write("<area id='areablock'  shape='rect' coords='0,0,18,18'  alt='关闭 '  />");
document.write("</map>");
document.write("</div>");
function setarea()
{
	var w=document.getElementById("icoimg").width;
    
	document.getElementById("areablock").setAttribute("coords",(w-17)+",0,"+w+",12");
    document.getElementById("areablock").onclick=function(){

        document.getElementById("ttkefuico").style.display="none";
        document.getElementById('icoimg').onclick=function(){document.getElementById("ttkefuico").style.display="none";}
        
		}
    document.getElementById("areablock").onmouseover=function(){document.getElementById('icoimg').style.cursor='default'}
    document.getElementById("areablock").onmouseout=function(){document.getElementById('icoimg').style.cursor='pointer'}
        
}
document.write("<div id='ttkefutel' style='position:fixed;_position:absolute;overflow:hidden; z-index:1000;left: 1px;top:395px;'>");
document.write("<img id='ttkefutel_img' style='cursor:pointer;display:block; clear:both;'  onClick=randtantel() src='https://w1011.ttkefu.com/images/telstyle/0.gif' border='0'  usemap='#ttkefutelMap' onload='telsetarea()' />");
document.write("<map name='ttkefutelMap' id='ttkefutelMap' >");
document.write("<area id='telareablock'  shape='rect' coords='0,0,18,18'  alt='关闭 '  />");
document.write("</map>");
document.write("</div>");

document.write('<div id="ttkefu_freetel" style="width: 254px; height:53px; margin:0px; padding:0px; background:#ffffff; position:fixed;_position:absolute; z-index:99999999; left:-254px; top:405px;overflow:hidden;">');	
document.write('<div id="ttkefu_freetel_title" style="width:100%; height:53px; margin:0px; padding:0px; background: #2bbe58;color: #fff;overflow: hidden;font-family: 微软雅黑;">');
document.write('<span style="width: 46px;height: 41px;margin: 6px 0px 0 12px;padding: 0px;display: block;float: left;background: url(https://w1011.ttkefu.com/images/tel.png) no-repeat 0px 15px;background-position: -24.189px 0.4196px;" class="span_tel"></span>');
document.write('<span style="width:110px;height:53px; text-align:right;line-height:53px;padding:0px 0 0 0px;float:left;display: block;font-size:26px;">免费电话</span>');
document.write('<a id="ttkefu_freetel_close" onClick="ttkefutel_close()" href="javascript:void(0)" class="close_btn" style="float:right; width:23px;height:40px;background: url(https://w1011.ttkefu.com/images/tel.png) no-repeat 0px 15px; margin:0px 15px 0px 0px;"></a>');
document.write('</div>');
document.write('<div id="ttkefu_freetel_content" style=" width:100%;margin:0px; padding:6px 0px 0px 0px; overflow:hidden;" class="zx_nr">');
document.write('<div id="ttkefu_freetel_step1" style="width:100%; overflow:hidden; margin:0px; padding:0px 0px 0px 16px;">');
document.write('<p style="color: #a9a9a9;font-size: 12px;line-height: 18px;font-family: 宋体;letter-spacing: 0.1em;padding: 10px 0px 16px 0px; margin:0px; text-align:left;">本通话使用电话回拨能力，完全免费<br>将对您的号码严格保密，请放心使用</p>');
document.write('<form action="" id="form_ttkefutel" name="form_ttkefutel" method="post" >');
    document.write('<div id="ttkefu_freetel_inform_div"  style="margin:0px; padding:0px;">');
    document.write('<dl style="width: 324px;height:42px;overflow: Hidden;padding: 0 0 7px; margin:0px;">');
document.write('<dt style="width: 324px;overflow: Hidden; margin:0px; padding:0px;">');
document.write('<input name="input_ttkefutel" id="input_ttkefutel" type="text" value="请输入您的手机号"  style="width:213px;color:#c8c8c8;padding:0px 5px;border:solid 1px #bdc7d8;height:45px;line-height:45px;font-size: 14px;font-family: 宋体; float:left;"><input name="input_ttkefutel_area" id="input_ttkefutel_area" type="hidden"  ></dt>');
document.write('</dl>');
//电话注释
document.write('<dl style="width: 324px;height:15px;overflow: Hidden;padding: 0 0 7px; margin:0px; ">');
document.write('<dt style="width: 324px;overflow: Hidden; margin:0px; padding:0px;">');
document.write('<input name="input_ttkefucode" id="input_ttkefucode" type="text" style="display:none;width:140px; float:left; margin:0px 7px 0px 0px;color:#c8c8c8;border:solid 1px #bdc7d8;height:45px;line-height:45px;font-size:14px;font-family:宋体; padding:0px 5px;" value="验证码" onClick="fn_focus(this);" onBlur="fn_blur(this);">');
document.write('<img id="randCodeImgConsult"  src="https://w1011.ttkefu.com/chkcode.jsp" style="display:none; cursor:pointer; float:left;width:72px;height:45px" ><div id="ttkefu_codeError" style="display:none;clear: both;height: 22px;line-height: 22px;background: #ffcfcf;border: solid 1px #eaacac;border-top: none;width: 121px;font-size:12px;color:#ff0000;padding:0px 12px 0px 12px;font-family:宋体;"  ></div>');
document.write('</dt>');
document.write('</dl>');

document.write('<dl style="width: 324px;overflow: Hidden;padding: 0 0 7px; margin:0px; ">');
document.write('<dt style="width: 324px;overflow: Hidden; margin:0px; padding:0px;">');
document.write('<div id="verify_box" style="visibility:hidden;-webkit-user-select: none;width: 225px;height: 40px;text-align: center;line-height: 40px;font-size: 14px;color:#fff;bottom: 77px;position: absolute;background-color: rgba(212, 212, 212, 1);">');
document.write('<div id="verify_xbox" style="width: 54px;height: 40px;text-align: center;line-height: 40px;font-size: 14px;color:#fff;position: absolute;background: #7BBB55;"><div id="aa" style=""></div><div id="btn" style="cursor: pointer;width: 52px;height: 38px;background-color: rgba(255, 255, 255, 1);border: solid 1px rgba(212, 212, 212, 1);float: right;">');
document.write('<div id="ss" style="width: 22px;height: 21px;position: absolute;margin: 14px 0px 0 16px;float: left;background: url(https://w1011.ttkefu.com/images/tel.png) no-repeat 0px 15px;background-position: -21.189px -41.5804px;"></div>');
document.write('</div></div>&nbsp; &nbsp; &nbsp; &nbsp;按住滑块，拖动到最右边');
document.write('</div>');
document.write('</dt>');
document.write('</dl>');

document.write('<a href="javascript:void(0)" count="1" style="margin:0px 0 0 29px;width: 167px;height: 40px;line-height: 40px;text-align: center;background: #2bbe58;border: none;display: block;color: #fff;font-size: 16px;font-family: 微软雅黑;text-decoration:none;" onMouseOver=if(this.innerHTML=="开始通话"){ttkefutel_onmouseover(this)} onMouseOut=if(this.innerHTML=="开始通话"){ttkefutel_onmouseout(this)}  id="ttkefu_ZiXun">开始通话</a>');
document.write('</div>');  
document.write('</form>');
document.write('</div>');
document.write('<div id="ttkefu_freetel_step2"  style="display: none; text-align:center; padding:0px;"><p style="margin:0px; padding:32px 0px 16px 0px; color:#a9a9a9;font-size: 12px;line-height: 18px;font-family: 宋体;letter-spacing: 0.1em;">正在呼叫，请注意接听来电</p>');
document.write('<img src="https://w1011.ttkefu.com/images/tel_ing1.png">');
document.write('<a id="ttkefu_freetel_close1" onMouseOver="ttkefutel_onmouseover(this)" onMouseOut="ttkefutel_onmouseout(this)" onClick="ttkefutel_close()" href="javascript:void(0)"  style="width: 167px;height: 40px;line-height: 40px;text-align: center;background:#2bbe58;margin:54px auto 0;border: none;display: block;color: #fff;font-size: 16px;font-family: 微软雅黑;text-decoration:none;">关闭</a>');
document.write('</div>');	
document.write('</div>');	
document.write('</div>');
...
element.onmousedown = function(e) {
    ...
    document.onmouseup = function(e){
        var l = e.clientX - disX +o;
        var curCount =document.getElementById("ttkefu_ZiXun").getAttribute("count");
        if(l<b){
            l=o
        }else{
            l=b;
            document.getElementById('aa').innerHTML="验证通过";
			document.getElementById('ss').sec="https://w1011.ttkefu.com/images/tel.png";
			document.getElementById('ss').style.backgroundPosition="-0.189px -28.5804px";
			document.getElementById('ss').style.right="10px";
			document.getElementById('ss').style.bottom="9px";
			document.getElementById('btn').style.border="none";
            setTimeout(function(){
                    document.getElementById("verify_box").style.visibility="hidden";
                    document.getElementById("ttkefu_ZiXun").setAttribute("count",parseInt(curCount)-1);
                    document.getElementById('verify_xbox').style.width="54px";
                    document.getElementById('aa').innerHTML="";
					document.getElementById('ss').style.backgroundPosition="-21.189px -41.5804px";
			        document.getElementById('ss').style.right="";
			        document.getElementById('ss').style.bottom="";
			        document.getElementById('btn').style.border="solid 1px rgba(212, 212, 212, 1)";
                    }, 1000);
        }
        xbox.style.width = l + 'px';
...
function telsetarea()
{
	var w=document.getElementById("ttkefutel_img").width;
	document.getElementById("telareablock").setAttribute("coords",(w-17)+",0,"+w+",12");
    document.getElementById("telareablock").onclick=function(){
         document.getElementById('ttkefutel').style.display="none";
        document.getElementById('ttkefutel_img').onclick=function(){document.getElementById('ttkefutel').style.display="none";;}
        
		}
    document.getElementById("telareablock").onmouseover=function(){document.getElementById('ttkefutel_img').style.cursor='default'}
    document.getElementById("telareablock").onmouseout=function(){document.getElementById('ttkefutel_img').style.cursor='pointer'}
        
}

/*鼠标经过，离开特效*/
function ttkefutel_onmouseover(obj)
{
	obj.style.backgroundColor="#1c7c39";
}
function ttkefutel_onmouseout(obj)
{
	obj.style.backgroundColor="#2bbe58";
}



/*电话关闭*/
function ttkefutel_close(){
	document.getElementById("ttkefu_freetel").style.height="50px";
    setTimeout(function(){
    	document.getElementById('ttkefu_freetel').style.left="-254px";

        document.getElementById("ttkefu_freetel_step1").style.display="";
        document.getElementById("ttkefu_freetel_step2").style.display="none";
        document.getElementById("ttkefu_codeError").style.display="none";
        document.getElementById("form_ttkefutel").reset();
        /*图标*/
        document.getElementById('ttkefutel').style.display="";
        
    },450);
}
/*电话显示*/
document.getElementById("ttkefutel_img").onclick=function(){
			 /*图标*/
        	document.getElementById('ttkefutel').style.display="none";
            document.getElementById('ttkefu_ZiXun').innerHTML='开始通话';
            document.getElementById('ttkefu_ZiXun').style.background='#2bbe58';
            /*列表*/
            var jsx=-254,jsy=0;
            var xx=setInterval(function(){
            	jsx=jsx+15;
                document.getElementById("ttkefu_freetel").style.left=jsx+"px";  
                
                if(jsx==-14){
                	document.getElementById("ttkefu_freetel").style.left="1px";
                	clearInterval(xx);
                    /*高度*/
                    var yy=setInterval(function(){
                    var currenth=document.getElementById("ttkefu_freetel").style.height;
                	currenth=parseInt(currenth.substring(0,currenth.length-2));
                    
                    document.getElementById("ttkefu_freetel").style.height=(currenth+10)+"px";
                    jsy=jsy+1;
                    	if(jsy==25){
                        	document.getElementById("ttkefu_freetel").style.height="316px";
                        	clearInterval(yy);
                        }
...
/*电话号码，验证码*/
document.getElementById("input_ttkefutel").onfocus=function(){
	if(this.value=="请输入您的手机号"){
    	document.getElementById("input_ttkefutel").value="";
    	this.style.color="#333333";
    }

}
document.getElementById("input_ttkefutel").onblur=function(){
	if(this.value==""){
    	this.value="请输入您的手机号";
...
document.getElementById("input_ttkefucode").onfocus=function(){
	if(this.value=="验证码"){
    	this.value="";
    	this.style.color="#333333";
    }
}
document.getElementById("input_ttkefucode").onblur=function(){
	if(this.value==""){
    	this.value="验证码";
        this.style.color="#c8c8c8";
    }
...
document.getElementById("randCodeImgConsult").onclick=function(){
	document.getElementById("randCodeImgConsult").src="https://w1011.ttkefu.com/chkcode.jsp?a="+Math.random();
}
...
/*-----setCookie记录------*/
 function setCookie(cname,cvalue,exdays) {
                          var d = new Date();
                          d.setTime(d.getTime() + (exdays*6000*5));
                        ...
                        var user=getCookie("bb");
		                if(user==1){
                          document.getElementById("ttkefu_ZiXun").setAttribute("count",2)
                        }

/**/

 
document.getElementById("ttkefu_ZiXun").onclick=function(){
	
    
    var ttkefutel = document.getElementById("input_ttkefutel").value;
    var tel = /^1(3|4|5|6|7|8|9)[0-9]{9}$/;
  if(!tel.test(ttkefutel)){
        var new_script = document.createElement("script");
	new_script.src ="https://w1011.ttkefu.com/addtel.jsp?input_ttkefutel="+document.getElementById("input_ttkefutel").value+"&ttkefucode="+document.getElementById("input_ttkefucode").value+"&sjs="+sjs+"&fgid=7158&kuse=54982&lang=0&x="+Math.random();;
	document.getElementsByTagName("HEAD")[0].appendChild(new_script);
    
  }else{
            var curCount =document.getElementById("ttkefu_ZiXun").getAttribute("count");
                    if(parseInt(curCount)>1){
                       document.getElementById("verify_box").style.visibility="initial";
                       
                    }else{
                       document.getElementById("ttkefu_ZiXun").setAttribute("count",parseInt(curCount)+1)
                       user=curCount ;
                       document.getElementById("ttkefu_ZiXun").innerHTML="提交中";
                       document.getElementById("ttkefu_ZiXun").style.background="#cccccc";
                       
                       var new_script = document.createElement("script");
	new_script.src ="https://w1011.ttkefu.com/addtel.jsp?input_ttkefutel="+document.getElementById("input_ttkefutel").value+"&ttkefucode="+document.getElementById("input_ttkefucode").value+"&sjs="+sjs+"&fgid=7158&kuse=54982&lang=0&x="+Math.random();;
	document.getElementsByTagName("HEAD")[0].appendChild(new_script);
                    }
                  setCookie("bb", user, 30); 	
...
function ttkefu_teltishi(link){
	var new_script = document.createElement("script");
    new_script.id="tel_script";
	new_script.src =link+"&x="+Math.random();
	document.getElementsByTagName("HEAD")[0].appendChild(new_script); 
}
